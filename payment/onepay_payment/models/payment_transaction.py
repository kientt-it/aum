...
class PaymentTransaction(models.Model):
    ...
    def _query_onepay_transaction_status(self):
        ...
        params['vpc_SecureHash'] = PaymentProviderOnePay.generate_secure_hash(string_to_hash,
                                                                              self.provider_id.onepay_secret_key)
        ...
        if fields.Datetime.now() < self.onepay_query_start_time + timedelta(
                minutes=15) and not self.onepay_query_status:
