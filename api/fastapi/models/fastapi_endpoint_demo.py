...
class FastapiEndpoint(models.Model):
    ...
    app: str = fields.Selection(
        selection_add=[("data", "Demo Endpoint")], ondelete={"data": "cascade"}
    )
    ...
    def _valdiate_demo_auth_method(self):
        for rec in self:
            if rec.app == "data" and not rec.demo_auth_method:
    ...
    def _get_app(self):
        ...
        if self.app == "data":
            ...
            # according to the authentication method configured on the data app
    ...
    def _prepare_fastapi_app_params(self) -> dict[str, Any]:
        ...
        if self.app == "data":
            ...
            tags_metadata.append({"name": "data", "description": demo_router_doc})
...
def api_key_based_authenticated_partner_impl(
    api_key: Annotated[
        ...
        Depends(
            APIKeyHeader(
                name="api-key",
                description="In this data, you can use a user's login as api key.",
            )
        ),
    ],
